...
SECRET_KEY = 'django-insecure-5b6d9$sh@=geo7r!d@3(kk&o$ho^i%712)1uztf_fhcha1u1dk'
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'toolbar2': 'bold italic underline | alignleft aligncenter alignright alignjustify '
               '| bullist numlist | outdent indent| link image | preview code | tiny_mce_wiris_formulaEditor tiny_mce_wiris_formulaEditorChemistry',
